...
```
docker tag kirschbaumdevelopment/laravel-test-runner:latest kirschbaumdevelopment/laravel-test-runner:7.3.0
```

**Push**:

```
docker push kirschbaumdevelopment/laravel-test-runner:7.3.0
```
