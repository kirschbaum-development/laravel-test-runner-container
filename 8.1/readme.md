...
```
docker tag kirschbaumdevelopment/laravel-test-runner:latest kirschbaumdevelopment/laravel-test-runner:8.1
```

**Push**:

```
docker push kirschbaumdevelopment/laravel-test-runner:8.1
```
